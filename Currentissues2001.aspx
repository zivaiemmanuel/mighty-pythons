    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Braamfointain, 2001</h2>
          <p>These are current issues in your area if something is inaccurate please dont hesitate to contact use </p>
        </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-blue">
              ...
              <h4><a href="">Braam park</a></h4>
              <p>The park in braamfointain accross from mtn taxi rank is close for the week due to the fire that happend</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-orange ">
              ...
              <h4><a href="">New town junction</a></h4>
              <p>The newtown junction is currently expering a power outage city power is working on the issue curently the power should be back by 20;00 today </p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box iconbox-pink">
              ...
              <h4><a href="">Robbery</a></h4>
              <p>Police are still on the look out for the suspects who robed a shop on biccard street</p>
            </div>
          </div>
